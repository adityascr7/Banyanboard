...
<head>
    ...
    <script defer="defer" src="/restaurant_website/static/js/app.64a48d12.js"></script>
    <link href="/restaurant_website/static/css/app.89ff249f.css" rel="stylesheet">
</head>

<body>
    <div id="root" style="height:100vh">
        <div class="p-Home Flex1 bpt">
            <div class="p-Home Menu1 bpt" style="position: relative;margin-left: -120px;">
                <div><svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg" role="img" style="stroke: black;">
            ...
            <div class="p-Home Flex2 bpt">
                ...
                <div class="p-Home Flex138 bpt">
                    ...
                    <a href="javascript:void(0)" class="p-Home TextBox2 bpt">About</a>
                    <a href="javascript:void(0)" class="p-Home TextBox3 bpt">Menu</a>
                    <a href="javascript:void(0)" class="p-Home TextBox4 bpt">Pages</a>
                    <a href="javascript:void(0)" class="p-Home TextBox6 bpt">Cart</a>
                </div>
            </div>
            <div class="p-Home Flex3 bpt">
                <button class="p-Home Button1 bpt">Order online</button>
                <button class="p-Home Button2 bpt">Reservate</button>
            </div>
           
        </div>
        <div class="p-Home Flex5 bpt">
            <div class="p-Home Flex6 bpt">
                <div class="p-Home Flex10 bpt">
                    <div class="p-Home TextBox7 bpt">The best place to</div>
                    <div class="p-Home TextBox8 bpt">eat burgers in LA.</div>
                </div>
                <div class="p-Home TextBox9 bpt">
                    Let's take care of ourselves, <br>
                    let's not live in hatred for tomorrow, <br>
                    let's not live in hatred.<br>
                </div>
                <div class="p-Home Flex8 bpt">
                    <div class="p-Home Flex9 bpt"><button class="p-Home Button3 bpt">Reservate</button><button
        ...
        <div class="p-Home Flex13 bpt">
            ...
            <div class="p-Home Flex25 bpt"><button class="p-Home Button9 bpt">Order online</button><button
